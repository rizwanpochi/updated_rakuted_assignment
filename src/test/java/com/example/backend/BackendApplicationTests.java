...
public class BackendApplicationTests {
	...
	public void backTest3() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/all").contentType(MediaType.APPLICATION_JSON)
				.content("{\n" + "	\"files\": [{\n" + "			\"models\": [{\n" + "				\"edges\": [{\n"
						+ "						\"id\": \"2067c9f4-4269-4499-ad16-5742d75bc9fd\",\n"
						+ "						\"name\": \"correct_pin\",\n"
						+ "						\"sourceVertexId\": \"f655d4c2-4203-4590-9ab7-c4fef5554955\",\n"
	...
	public void backTest2() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/common").contentType(MediaType.APPLICATION_JSON)
				.content("{\n" + "	\"files\": [{\n" + "			\"models\": [{\n" + "				\"edges\": [{\n"
						+ "						\"id\": \"2067c9f4-4269-4499-ad16-5742d75bc9fd\",\n"
						+ "						\"name\": \"correct_pin\",\n"
						+ "						\"sourceVertexId\": \"f655d4c2-4203-4590-9ab7-c4fef5554955\",\n"
